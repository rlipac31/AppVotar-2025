...
export default function ComoFuncionaCards() {
  const pasos = [
    ...
    },
    {
      ...
      descripcion: 'Tu DNI valida que eres un ciudadano único. Se encripta y se descarta tras procesar el voto.',
  ...
  return (
    <div className="max-w-7xl mx-auto px-6">
      <div className="text-center mb-16">
        ...
        <div className="w-20 h-1.5 bg-french-blue-600 mx-auto rounded-full" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {pasos.map((paso, index) => (
          <div 
            key={index} 
            className="group p-8 bg-white border border-gray-100 rounded-3xl shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:bg-french-blue-900/20 dark:border-french-blue-800"
          >
            ...
            <p className={`${roboto.className} text-gray-600 dark:text-french-blue-300 leading-relaxed`}>
              {paso.descripcion}
            </p>
          </div>
        ))}
